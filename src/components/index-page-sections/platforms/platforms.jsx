    ...
    <section id="platforms" className={cx('platforms')}>
      ...
      <LayoutSectionContainer>
        <div className={cx('platformsGrid')}>
          {platforms.map(({ image: Image, ...platform }) => (
            <div
              key={platform.id}
              className={cx('platformsGridPlatform')}
            >
              <div
                className={cx('platformsGridPlatform_topContainer')}
              >
                {typeof Image === 'string' ? (
                  <img
                    src={Image}
      ...
      >
        ...
        <DialogContent>
          ...
          />
          <DialogContentText>
            We are working hard on these awesome integrations. Leave
            us a note in our chat bot to get notified.
          </DialogContentText>
        </DialogContent>
      </Dialog>
    </section>
