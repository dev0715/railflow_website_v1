...
const TestFrameworkPage = () => {
  const feature = {
    heroTitle: 'Test Framework Consultation',
    ...
    featureList: [
      {
        id: "test-framework-feature-1",
        title: "Test Framework Feature 1",
        text: `
      ...
      {
        id: "test-framework-feature-2",
        title: "Test Framework Feature 2",
        text: `
          Proin ac quam et lectus vestibulum blandit.
          Nunc maximus nibh at placerat tincidunt.
          Nam sem lacus, ornare non ante sed, ultricies fringilla massa.
...
export default TestFrameworkPage
